...
"""
    # -> Solid stone wall / perimeter
    $ -> Hidden contraband / coins
    @ ->  (Lockpick/Paper clip)
    ? -> Guard schedules / Optional lore paper 
    ! -> Breakable wooden door / Weak wall
    _ -> Moving elevator platform
    ^ -> Heavy iron gate (animated to slide up)
    | -> Iron cell bars (blocking movement)
    G -> Guard patrol points
    X -> Security cameras / spotlights
