    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if input_allowed and event.key in (pygame.K_SPACE, pygame.K_w, pygame.K_UP):
                ...
                if input_allowed and event.key == pygame.K_f:
